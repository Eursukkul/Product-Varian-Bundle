    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleItems_BundleId_ItemType_ItemId",
                table: "BundleItems",
                columns: new[] { "BundleId", "ItemType", "ItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BundleItems_ItemType_ItemId",
                table: "BundleItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductMasters_IsActive_CategoryId",
                table: "ProductMasters",
                columns: new[] { "IsActive", "CategoryId" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductMasters_Name",
                table: "ProductMasters",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantAttributes_ProductVariantId_VariantOptionValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductMasterId_IsActive",
                table: "ProductVariants",
                columns: new[] { "ProductMasterId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_ItemType_ItemId_WarehouseId",
                table: "Stocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_WarehouseId_ItemType_ItemId",
                table: "Stocks",
                columns: new[] { "WarehouseId", "ItemType", "ItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VariantOptions_ProductMasterId_DisplayOrder",
                table: "VariantOptions",
                columns: new[] { "ProductMasterId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_VariantOptionValues_VariantOptionId_DisplayOrder",
                table: "VariantOptionValues",
                columns: new[] { "VariantOptionId", "DisplayOrder" });
